...
$(document).ready(function () {
    ...
    const APIKEY = "61efa7577e552722950170d8";
    ...
    $("#contact-submit").on("click", function (e) {
      ...
      let settings = {
        "async": true,
        "crossDomain": true,
        "url": "https://assignment2-fa9a.restdb.io/rest/contact",
    ...
    contactMsg) {
      ...
      var settings = {
        "async": true,
        "crossDomain": true,
        "url": `https://assignment2-fa9a.restdb.io/rest/contact/${id}`,//update based on the ID
        "method": "PUT",
        "headers": {
          "content-type": "application/json",
          "x-apikey": APIKEY,
    ...
    function deleteRecord(id) {
      var settings = {
        "async": true,
        "crossDomain": true,
        "url": `https://assignment2-fa9a.restdb.io/rest/contact/${id}`,
        "method": "DELETE",
         "headers": {
          "content-type": "application/json",
          "x-apikey": APIKEY,
